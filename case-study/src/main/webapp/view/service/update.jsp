...
<body>
<h4 class="p-3 bg-warning text-white text-center">Cập nhật dịch vụ</h4>

<div class="d-flex justify-content-center">
    <select class="form-select-lg w-50 m-auto mt-3 border-warning rounded-pill" name="" id="addSelect"
...
<div class="d-flex justify-content-center">
    <form action="" class="text-warning fw-bold bg-light w-75 mt-5 mb-5 shadow-lg p-5">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 ">
                ...
                <div class="mb-3 " style="display: none" id="divDichVuMienPhi">
                    ...
                    <input type="text" class="form-control" aria-describedby="emailHelp"
                           value="2"id="dichVuMienPhi">
                </div>
            </div>
        </div>
        <div>
            <a class="btn btn-primary" href="/Service">Quay lại</a>
            <button type="submit" id="add" class="btn btn-warning text-white">Cập nhật</button>
        </div>
    </form>
